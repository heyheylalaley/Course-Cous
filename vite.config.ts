      ...
      build: {
        ...
        rollupOptions: {
          output: {
            ...
            manualChunks: (id) => {
              // React и React-DOM в отдельный чанк (проверяем первым для избежания циклических зависимостей)
              ...
              // Остальные node_modules - пусть Vite сам решит (вернет undefined)
