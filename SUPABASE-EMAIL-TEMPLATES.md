# Supabase Email Templates (EN + UA)
...
**Subject:**
```
Confirm your email / Підтвердіть вашу електронну пошту
```
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f5; margin: 0; padding: 20px;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="background: linear-gradient(135deg, #16a34a 0%, #15803d 100%); padding: 30px; text-align: center;">
      ...
      <p style="color: #bbf7d0; margin: 5px 0 0 0; font-size: 14px;">Training Center</p>
    </div>
    ...
    <div style="padding: 40px 30px;">
      ...
      <!-- Ukrainian -->
      <div>
        <h2 style="color: #111827; margin: 0 0 15px 0; font-size: 20px;">Ласкаво просимо!</h2>
        <p style="color: #4b5563; line-height: 1.6; margin: 0 0 20px 0;">
          Дякуємо за реєстрацію. Будь ласка, підтвердіть свою електронну адресу, натиснувши кнопку нижче:
        </p>
        <a href="{{ .ConfirmationURL }}" style="display: inline-block; background-color: #16a34a; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px;">
          Підтвердити Email
        </a>
...
**Subject:**
```
You've been invited / Вас запрошено
```
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 40px 30px;">
      ...
      <div style="margin-bottom: 30px; padding-bottom: 30px; border-bottom: 1px solid #e5e7eb;">
        ...
        <p style="color: #4b5563; line-height: 1.6; margin: 0 0 20px 0;">
          You have been invited to join Cork City Partnership Training Center. Click the button below to accept the invitation and create your account:
        </p>
        <a href="{{ .ConfirmationURL }}" style="display: inline-block; background-color: #16a34a; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px;">
          Accept Invitation
        </a>
      ...
      <!-- Ukrainian -->
      <div>
        <h2 style="color: #111827; margin: 0 0 15px 0; font-size: 20px;">Вас запрошено!</h2>
        <p style="color: #4b5563; line-height: 1.6; margin: 0 0 20px 0;">
          Вас запрошено приєднатися до Cork City Partnership Training Center. Натисніть кнопку нижче, щоб прийняти запрошення та створити свій обліковий запис:
        </p>
        <a href="{{ .ConfirmationURL }}" style="display: inline-block; background-color: #16a34a; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px;">
          Прийняти запрошення
        </a>
...
**Subject:**
```
Your login link / Ваше посилання для входу
```
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f5; margin: 0; padding: 20px;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 40px 30px;">
      ...
      <!-- Ukrainian -->
      <div>
        <h2 style="color: #111827; margin: 0 0 15px 0; font-size: 20px;">Увійдіть до свого облікового запису</h2>
        <p style="color: #4b5563; line-height: 1.6; margin: 0 0 20px 0;">
          Натисніть кнопку нижче, щоб увійти до свого облікового запису. Це посилання діятиме 24 години.
        </p>
        <a href="{{ .ConfirmationURL }}" style="display: inline-block; background-color: #16a34a; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px;">
          Увійти
        </a>
...
**Subject:**
```
Confirm your new email / Підтвердіть нову електронну пошту
```
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f5; margin: 0; padding: 20px;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 40px 30px;">
      ...
      <!-- Ukrainian -->
      <div>
        <h2 style="color: #111827; margin: 0 0 15px 0; font-size: 20px;">Підтвердіть нову електронну пошту</h2>
        <p style="color: #4b5563; line-height: 1.6; margin: 0 0 20px 0;">
          Ви запросили зміну електронної адреси. Натисніть кнопку нижче, щоб підтвердити нову електронну пошту:
        </p>
        <a href="{{ .ConfirmationURL }}" style="display: inline-block; background-color: #16a34a; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px;">
...
**Subject:**
```
Reset your password / Скидання пароля
```
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f5; margin: 0; padding: 20px;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 40px 30px;">
      ...
      <!-- Ukrainian -->
      <div>
        <h2 style="color: #111827; margin: 0 0 15px 0; font-size: 20px;">Скидання пароля</h2>
        <p style="color: #4b5563; line-height: 1.6; margin: 0 0 20px 0;">
          Ви запросили скидання пароля. Натисніть кнопку нижче, щоб створити новий пароль:
        </p>
        <a href="{{ .ConfirmationURL }}" style="display: inline-block; background-color: #16a34a; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px;">
          Скинути пароль
        </a>
        <p style="color: #9ca3af; font-size: 13px; margin: 20px 0 0 0;">
          Це посилання діятиме 24 години.
        </p>
      </div>
    </div>
...
**Subject:**
```
Confirm your identity / Підтвердіть вашу особу
```
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f5; margin: 0; padding: 20px;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 40px 30px;">
      ...
      <!-- Ukrainian -->
      <div>
        <h2 style="color: #111827; margin: 0 0 15px 0; font-size: 20px;">Підтвердіть вашу особу</h2>
        <p style="color: #4b5563; line-height: 1.6; margin: 0 0 20px 0;">
          З міркувань безпеки, будь ласка, підтвердіть свою особу, натиснувши кнопку нижче:
        </p>
        <a href="{{ .ConfirmationURL }}" style="display: inline-block; background-color: #16a34a; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px;">
          Підтвердити особу
        </a>
...
- All templates include both English and Ukrainian versions
